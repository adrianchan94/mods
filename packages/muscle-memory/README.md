...
> *The agent works → muscle-memory reviews across sessions → distills/updates a class-level skill (update-first) → `💾 muscle-memory review:` summary + evidence manifest → measured runtime gain. Hermes's loop, Letta-native. (`docs/demo.gif`)*
