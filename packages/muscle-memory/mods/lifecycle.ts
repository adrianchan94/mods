...
import { Row, USAGE_PATH, appendMeshFeed, appendUiEvent, ensureDir, isManaged, listSkillNames, loadRows, readSkill, scanDirs, skillDesc, slug, writeUiState } from "./core";
...
export function retireManagedSkill(name: string, reason: string, ctx?: any, absorbedInto?: string): string {
  const dirs = scanDirs(ctx);
