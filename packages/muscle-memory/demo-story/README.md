...
The **live model A/B** (real GLM-5.2) is receipted separately in
[`../head-to-head/effectiveness/`](../head-to-head/effectiveness/): on held-out knowledge-gap tasks a
fresh agent went from **33% → 100%** with the distilled skill. The demo's scoreboard is a clean,
reproducible illustration of that effect — not a substitute claim.
